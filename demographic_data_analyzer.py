...
def calculate_demographic_data(print_data=True):
  ...
  proportions = df.loc[df['salary'] == '>50K', 'native-country'].value_counts() / df['native-country'].value_counts()
  
  highest_earning_country = proportions.idxmax()
  highest_earning_country_percentage = round(proportions.loc[highest_earning_country] * 100, 1)
  
  
  # Identify the most popular occupation for those who earn >50K in India.
  india_high_earners = df[(df['salary'] == '>50K') & (df['native-country'] == 'India')]
  IN_occupations = india_high_earners['occupation'].value_counts()
  top_IN_occupation = IN_occupations.idxmax()
